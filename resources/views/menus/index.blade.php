        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    @if($menu)
                        <div class="mb-8">
                            <h3 class="text-lg font-semibold text-gray-700 mb-4">Today's Dishes</h3>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="bg-green-100 p-4 rounded-lg shadow">
                                    <h4 class="font-bold text-green-800 mb-2">Main Dish</h4>
                                    <p class="text-green-700">{{ $menu->dishes->where('type', 'main')->first()->name }}</p>
                                </div>
                                <div class="bg-blue-100 p-4 rounded-lg shadow">
                                    <h4 class="font-bold text-blue-800 mb-2">Side Dish 1</h4>
                                    <p class="text-blue-700">{{ $menu->dishes->where('type', 'sub1')->first()->name }}</p>
                                </div>
                                <div class="bg-purple-100 p-4 rounded-lg shadow">
                                    <h4 class="font-bold text-purple-800 mb-2">Side Dish 2</h4>
                    ...
                    @else
                        <p class="text-gray-600 mb-4">No menu for Monday yet.</p>
